...
public class AWS4SignerForAuthorizationHeader extends AWS4SignerBase {
    ...
    public String computeSignature(Map<String, String> headers,
        ...
        System.out.println(BinaryUtils.toHex(kDate));
        System.out.println(BinaryUtils.toHex(kRegion));
        System.out.println(BinaryUtils.toHex(kService));
        System.out.println(BinaryUtils.toHex(kSigning));
        System.out.println(BinaryUtils.toHex(signature));
        System.out.println("------------------------------------");
